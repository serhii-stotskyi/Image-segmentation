...
namespace IPLab
{
    ...
    public class ImageDoc : Content
    {
        ...
        private System.Windows.Forms.MenuItem averageColorFiltersItem;
        ...
        private void InitializeComponent( )
        {
            ...
            this.averageColorFiltersItem = new System.Windows.Forms.MenuItem( );
            ...
            this.cropImageItem.Text = "Обрезать";
            ...
            // averageColor
            //
            this.averageColorFiltersItem.Index = 18;
            this.averageColorFiltersItem.Text = "&Average";
            this.averageColorFiltersItem.Click += new System.EventHandler(this.averageColorFiltersItem_Click);
            //
            // rotateFiltersItem
            // 
        ...
        public void ExecuteCommand( ImageDocCommands cmd )
        {
            switch ( cmd )
            {
                ...
                case ImageDocCommands.Resize:		// resize the image
                    ResizeImage( );
                    break;
                case ImageDocCommands.AverageColor:  // average color
                    AverageColor();
                    break;
        ...
        {
            //AverageColorForm form = new AverageColorForm();
        ...
        private void averageColorFiltersItem_Click(object sender, System.EventArgs e)
        {
            AverageColor();
        }
